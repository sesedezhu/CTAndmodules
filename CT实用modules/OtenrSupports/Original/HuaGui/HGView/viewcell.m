...
- (void)setModel:(viewcellModel *)model{
    _model = model;
    int type = [_model.serial intValue];
    
//    NSString  *a = @"1234567";
//    int b= [[a substringWithRange:NSMakeRange(4,1)] intValue];
//    NSLog(@"b:%d",b);
    ...
    if (!_model.qihao) {
        ...
        //需要加判断，当没有值的时候不显示
        [_btn0 setTitle:_model.qihao forState:UIControlStateNormal];
    }
    if (!_model.number_1) {
        //需要加判断，当没有值的时候不显示
        [_btn1 setTitle:nil forState:UIControlStateNormal];
        ...
        //需要加判断，当没有值的时候不显示
        [_btn1 setTitle:_model.qswzh forState:UIControlStateNormal];
    }
    if (!_model.number_1) {
        //需要加判断，当没有值的时候不显示
        [_btn2 setTitle:nil forState:UIControlStateNormal];
        ...
        //需要加判断，当没有值的时候不显示
        [_btn2 setTitle:_model.number_1 forState:UIControlStateNormal];
    }
    if (!_model.number_2) {
        //需要加判断，当没有值的时候不显示
        [_btn3 setTitle:nil forState:UIControlStateNormal];
        ...
        //需要加判断，当没有值的时候不显示
        [_btn3 setTitle:_model.number_2 forState:UIControlStateNormal];
    }
    if (!_model.number_3) {
        //需要加判断，当没有值的时候不显示
        [_btn4 setTitle:nil forState:UIControlStateNormal];
        ...
        //需要加判断，当没有值的时候不显示
        [_btn4 setTitle:_model.number_3 forState:UIControlStateNormal];
    }
    if (!_model.number_4) {
        //需要加判断，当没有值的时候不显示
        [_btn5 setTitle:nil forState:UIControlStateNormal];
    }else{
        //需要加判断，当没有值的时候不显示
        [_btn5 setTitle:_model.number_4 forState:UIControlStateNormal];
    }
    if (!_model.number_5) {
        //需要加判断，当没有值的时候不显示
        [_btn6 setTitle:nil forState:UIControlStateNormal];
    }else{
        //需要加判断，当没有值的时候不显示
        [_btn6 setTitle:_model.number_5 forState:UIControlStateNormal];
    }
    if (!_model.number_6) {
        //需要加判断，当没有值的时候不显示
        [_btn7 setTitle:nil forState:UIControlStateNormal];
    }else{
        //需要加判断，当没有值的时候不显示
        [_btn7 setTitle:_model.number_6 forState:UIControlStateNormal];
    }
    if (!_model.number_7) {
        //需要加判断，当没有值的时候不显示
        [_btn8 setTitle:nil forState:UIControlStateNormal];
    }else{
        //需要加判断，当没有值的时候不显示
        [_btn8 setTitle:_model.number_7 forState:UIControlStateNormal];
    }
